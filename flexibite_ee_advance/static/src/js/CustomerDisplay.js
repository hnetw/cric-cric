odoo.define('flexibite_ee_advance.CustomerDisplay', function (require) {
"use strict";
    ...
    const models = require('flexibite_ee_advance.model');
        ...
        _buildChrome() {
            if ($.browser.chrome) {
                ...
                if (parseInt(chrome_version, 10) >= 50) {
                    loadCSS('/flexibite_ee_advance/static/src/css/chrome51.css');
                }
            }
